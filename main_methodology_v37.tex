...
OOD detection (Stress Test 5) & 94.0\% [91.5\%, 95.9\%]; 6\% false-negative rate (30/500)$^\ddagger$; residual uncaught risk $\sim$0.4\%$^\P$ after boundary proximity alert & Extreme composition (CO/H$_2$O $\gg 2$); \textbf{synthetic only}; FN rate unmeasurable on real data ($N{=}1$) \\
