...
\subsection{Spherical Grain Sensitivity: Mie vs.\ T-Matrix Comparison}\label{app:grain_sensitivity}
...
\subsection{Extended Discussion: Independence Assumption in the Residual Risk Calculation}\label{app:independence}
