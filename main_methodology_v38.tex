...
\textbf{Training cost.} Total training consumed $\sim$350~GPU-hours on an NVIDIA A100 ($\sim$50~kg~CO$_2$); pre-trained weights are provided at Zenodo upon acceptance to avoid re-training. The six-test stress suite and Af$\rho$ pipeline are reusable without GPU training.
