...
\begin{enumerate}
    \item \textbf{Measurement:} No physical parameters of any real comet are measured. All 2I/Borisov comparisons are consistency checks against published values.
